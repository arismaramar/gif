...
GITHUB_CMD="https://raw.githubusercontent.com/arismaramar/gif/"
...
END
    ...
    wget -q -O /etc/banner.txt "${GITHUB_CMD}main/fodder/FighterTunnel-examples/banner.txt" >/dev/null 2>&1
